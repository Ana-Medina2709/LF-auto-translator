...
const repoName = 'LF-auto-translator'; // Update this to match your actual repo name
...
export const CORPUS = {
  ...
  DOMAIN: 'LF', // Update this to match your domain code
  
  // Vector file paths (dynamic for both local and GitHub Pages environments)
  // Update these to match your file paths and names
  VECTOR_PATHS: {
    document: `${basePath}/vectors/LF/LF-document-vectors.json`,
    section: `${basePath}/vectors/LF/LF-section-vectors.json`, 
    paragraph: `${basePath}/vectors/LF/LF-paragraph-vectors.json`
  },
  
  // Database paths (dynamic for both local and GitHub Pages environments)
  // Update these to match your file paths and names
  DATABASE_PATHS: {
    en: `${basePath}/corpora/LF/eng/LF-eng_database.json`,
    es: `${basePath}/corpora/LF/esp/LF-esp_database.json`
  }
};
